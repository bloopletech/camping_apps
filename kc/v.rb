      ...
      xhtml_transitional do
        ...
        body do
          div.wrap! do
            ...
            div.footer! do
              p { "&copy; 2008-#{Date.today.year} Brenton Fletcher. Check out <a href=\"http://i.bloople.net\">my portfolio</a>. Comments? <a href=\"mailto:i@bloople.net\">i@bloople.net</a>. Made on a Mac with Camping." }
            end
          end
        end
      end
