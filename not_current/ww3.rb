...
module WW3::Views
        ...
        style :type => 'text/css' do
          %{
            ...
            * { margin: 0; padding: 0; font-family: Impact, sans-serif; font-size: 100%; color: #000; background-color: #fff; }
            body { padding: 3px; font-size: 1.5em; line-height: 1.1; text-transform: uppercase; white-space: nowrap; }
          ...
          %{
            ...
            window.onload = function()
            {
               ...
               http.onreadystatechange = function()
               {
                 ...
                 {
                    p.innerHTML = http.responseText + p.innerHTML;
                    fixLinks();
                 }
              };
  ...
  def _edits(edits = @edits)
    ...
    "<span id='#{edits[0]['id']}'></span>" + edits.map { |edit| "#{edit['article_title']} • #{edit['edit_summary']} • #{edit['details']} • #{edit['word_diff']} • #{edit['author']}" }.join("<br />")
  end
end